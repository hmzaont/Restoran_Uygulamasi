//
//  FreeDeliveryCollectionViewCell.swift
//  BoltFood
//
...
class FreeDeliveryCollectionViewCell: UICollectionViewCell {
    ...
    static let reusableId = "FreeDeliveryCell"
    ...
    let foodDescriptionView: FoodDescriptionDetailsView = {
        ...
        v.actualPriceLabel.attributedText = NSMutableAttributedString(attributedString: NSAttributedString(string: "GH₵5.00", attributes: [NSAttributedString.Key.strikethroughStyle: NSUnderlineStyle.single.rawValue,NSAttributedString.Key.strikethroughColor: color.grey]))

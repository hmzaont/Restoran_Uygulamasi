...
//    }
    ...
    let button: UIButton = {
        ...
        b.setTitle("Devam Et", for: .normal)
...
extension RegisterVC {
    func setupViews(){
        ...
        termsLabel.attributedText = setAttributedTitle("Kaydolduğunda, ", "Gizlilik ve Tüketici Hakları Sözleşmesi","ni kabul etmiş olursun.")
    }

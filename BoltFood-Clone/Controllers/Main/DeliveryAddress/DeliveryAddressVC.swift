...
class DeliveryAddressVC: UIViewController {
    ...
    func addDeliveryAddress(){
        addressList.append(DeliveryAddress(location: "Konum", area: "Elazig", icon: "navigate",selected: false))
        addressList.append(DeliveryAddress(location: "Ev", area: "Yurt", icon: "home-outline",selected: false))
        addressList.append(DeliveryAddress(location: "Is", area: "Yurt, Elazig", icon: "work", selected: false))
        addressList.append(DeliveryAddress(location: "Elazig", area: nil, icon: "map-pin", selected: false))
        addressList.append(DeliveryAddress(location: "Turkiye", area: nil, icon: "map-pin", selected: false))
        addressList.append(DeliveryAddress(location: "Elazig", area: "Turkiye", icon: "map-pin", selected: false))
        addressList.append(DeliveryAddress(location: "Ilce", area: "Merkez", icon: "map-pin", selected: false))
        addressList.append(DeliveryAddress(location: "Elazig", area: "University of Firat", icon: "map-pin", selected: false))
        addressList.append(DeliveryAddress(location: "Turkiye", area: "Elazig, Turkiye", icon: "map-pin", selected: false))
    }
    // MARK: Properties -
    lazy var searchContainer: UIView = {
        let tap = UITapGestureRecognizer(target: self, action: #selector(didTapSearchView))
        let v = SearchView()
        v.placeholderText.text = "Yeni Adres Girin"
...
extension DeliveryAddressVC: UINavigationBarDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    private func configureNavBar(){
        ...
        navbarItem.title = "Siparis Adresi"

    ...
    var body: some View {
        ZStack{
            ScrollView{
                ...
                SectionTitleAll(title: "Özel Sipariş", titleAll: "Hepsini Gör") {
                ...
                SectionTitleAll(title: "En Çok Beğenilenler", titleAll: "Hepsini Gör") {
                ...
                SectionTitleAll(title: "Atıştırmalıklar", titleAll: "Hepsini Gör") {
